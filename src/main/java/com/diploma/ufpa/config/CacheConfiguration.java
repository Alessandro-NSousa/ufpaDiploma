package com.diploma.ufpa.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.diploma.ufpa.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.diploma.ufpa.repository.UserRepository.USERS_BY_EMAIL_CACHE);
